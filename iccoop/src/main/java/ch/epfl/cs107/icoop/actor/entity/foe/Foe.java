...
/**
 * Represents a generic foe with health, weaknesses, and invincibility frames.
 * Handles interactions, damage, and state updates such as death.
 */
public abstract class Foe extends MovableAreaEntity implements Interactor, TargetEntity, Logic {
    ...
    /**
     * Creates a Foe with health, weaknesses, and position.
     ...
     * @param position (DiscreteCoordinates): The initial position of the foe, not null.
     * @param maxLife (int): Maximum health points.
     * @param weaknesses (DamageType...): List of damage types the foe is vulnerable to.
     */
    ...
    /**
     * Checks if the foe is dead.
     * @return (boolean): True if the foe's health is zero, false otherwise.
     */
    ...
    /**
     * Applies damage to the foe if the damage type matches a weakness and the foe is not invincible.
     * @param damageType (DamageType): The type of damage inflicted.
     * @param quantity (int): The amount of damage inflicted.
     */
